...
int main()
{
    ...
    Texture planksTex(TEXTURE_DIR "/planks.png", GL_TEXTURE_2D, 0, GL_RGBA, GL_UNSIGNED_BYTE);
    planksTex.texUnit(shaderProgram, "tex0", 0);

    Texture planksSpec(TEXTURE_DIR "/planksSpec.png", GL_TEXTURE_2D, 1, GL_RED, GL_UNSIGNED_BYTE);
